...
class Delaunay_Obj_Import(bpy.types.Operator, ImportHelper):
    ...
    def execute(self, context):
        ...
        # Add to the list
        context.scene.tviz.add_delaunay_obj(obj_name, point_list, edge_list, face_list, tet_list)
